...
void World::build(void){
	...
	thinlens_ptr->set_lens_radius(1); // set d
	...
	sphere_ptr1->set_color(green);	   								// yellow
	add_object(sphere_ptr1);

	Sphere*	sphere_ptr2 = new Sphere(Point3D(40, 0, 100), 2);
	sphere_ptr2->set_color(green);	   								// yellow
	add_object(sphere_ptr2);

	Sphere*	sphere_ptr3 = new Sphere(Point3D(0, 0, 100), 2);
	sphere_ptr3->set_color(green);	   								// yellow
